...
const staticRoutes = ["/", "/blog", "/a-propos", "/ressources", "/contact", "/legal", "/test-personnalite-big-five", "/neuro-journal", "/stress-zero/", "/calculateur-sommeil/", "/hydromind/privacy-policy/"];
const articles = [
