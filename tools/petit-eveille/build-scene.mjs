...
<style>
  * { margin:0; padding:0; box-sizing:border-box; }
  ...
  .fx-idea { inset:0; }
  .fx-idea .bulb { position:absolute; left:50%; top:21%; width:11%; transform:translateX(-50%);
  ...
  .fx-bubble { inset:0; }
  .fx-bubble .box { position:absolute; left:57%; top:28%; max-width:36%; background:#fff; color:#1b1330; border-radius:14px;
