...
const About = () => {
  ...
  const team = [
    ...
    description: "Passionné par la psychologie et les neurosciences depuis 2020, j'ai créé L'Éveil Mental pour partager ce qui m'a aidé à mieux comprendre mon propre fonctionnement. Je suis autodidacte : je n'ai pas de diplôme en psychologie ou en neurosciences, mais je compense par un travail de fond systématique sur chaque sujet traité. Ma méthode suit toujours la même structure : partir d'un fait scientifique établi, expliquer le mécanisme neurologique concerné, puis en tirer une application pratique concrète. Chaque article s'appuie sur des études peer-reviewed, citées avec leur auteur, leur institution et leur année de publication, et nomme explicitement les chercheurs et les structures cérébrales en jeu, jamais une référence vague à \"des études\" sans source. Avant publication, chaque affirmation scientifique est vérifiée : je m'assure que les données citées proviennent bien d'études humaines et non animales sauf mention contraire, que le journal de publication est le bon, et que les chiffres avancés sont dans la bonne proportion. Cette exigence demande plus de temps qu'un article générique, mais c'est la condition pour que L'Éveil reste une source fiable plutôt qu'un résumé approximatif de ce qui circule déjà en ligne. Pas de pseudoscience, pas de promesses miracles, pas de jargon laissé sans explication : si un terme technique apparaît, il est immédiatement défini en langage courant.",
