    ...
    <>
      ...
      <article className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="prose prose-neutral dark:prose-invert max-w-none">
          ...
          <p>
            Développée dans les années 1960 par Marshall Rosenberg (psychologue américain, élève de Carl Rogers à l'Université du Wisconsin–Madison), la CNV repose sur un constat simple : la plupart des conflits naissent de <strong>besoins non exprimés</strong>, pas de malveillance. Sa méthode — structurée en 4 étapes que Rosenberg appelle OSBD — a depuis été testée dans des contextes très variés : couples, milieux de soin, établissements scolaires, programmes de réhabilitation en prison. La CNV n'est toutefois qu'une approche parmi les <Link to="/blog/resoudre-un-conflit-methodes-psychologie/" className="text-violet-600 dark:text-violet-400 underline underline-offset-2">méthodes validées pour résoudre un conflit</Link>, aux côtés de la méthode Harvard et des travaux de Gottman. La CNV est l'une des 7 compétences de notre <Link to="/blog/guide-communication-interpersonnelle/" className="text-violet-600 dark:text-violet-400 underline underline-offset-2">guide de la communication interpersonnelle</Link>.
          </p>
          <p>
