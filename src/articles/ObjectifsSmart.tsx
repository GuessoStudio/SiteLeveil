    ...
    <>
      ...
      <article className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="prose prose-neutral dark:prose-invert max-w-none">
          ...
          <p>
            Exemple : au lieu de « je vais méditer plus », tu formules « si je viens de me brosser les dents le matin, alors je médite trois minutes ». Le déclencheur concret (se brosser les dents) déclenche automatiquement l'action. Tu n'as plus à décider sur le moment, ce qui économise la volonté. Ancrer un plan « si/alors » dans une routine déjà installée est d'autant plus efficace, comme le détaille l'article sur <Link to="/blog/routine-matinale-scientifique-cerveau/" className="text-amber-600 dark:text-amber-400 underline underline-offset-2">la routine matinale et les 90 premières minutes</Link>.
          </p>
